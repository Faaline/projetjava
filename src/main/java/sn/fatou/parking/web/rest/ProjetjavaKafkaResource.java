...
@RestController
@RequestMapping("/api/projetjava-kafka")
public class ProjetjavaKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ProjetjavaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ProjetjavaKafkaResource(KafkaProperties kafkaProperties) {
